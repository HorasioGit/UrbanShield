...
export default function RootLayout({ children }) {
  return (
    ...
    >
      <body className="min-h-full flex overflow-hidden bg-[#020617]" suppressHydrationWarning>
        <Sidebar />
        <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
            ...
            <div className="absolute bottom-[-10%] right-[-10%] w-[30%] h-[30%] rounded-full bg-emerald-900/10 blur-[100px] pointer-events-none z-0"></div>
